...
## customers. A top-level domain is one that goes directly after the last dot 
## ('.') in the domain name, for example .com in example.com. To help the users 
## choose from available domains, GoDaddy is introducing a new feature that 
## shows the type of the chosen top-level domain. You have to implement this 
## feature.
...
## 
##     Example
##         For domains = ["en.wiki.org", "codesignal.com", "happy.net", 
##         "code.info"], the output should be
##         domainType(domains) = ["organization", "commercial", "network", 
##         "information"].
## 
##     Input/Output
...
##         A list of domains, where each domain contains at least one dot. It 
##         is guaranteed that each top-level domain of these domains belongs to 
